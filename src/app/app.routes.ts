...
[
  {
    ...
    [
      {
        path: 'Reservas',//'Crear nuevas reservas',
        title: 'Reservas',
        loadComponent: () => import('./dashboard/pages/reservar-calendario/reservar-calendario.component'),
      },
      {
        path: 'Crear nueva reserva',
        title: 'Nueva Reservas',
        loadComponent: () => import('./dashboard/pages/nueva-reserva/nueva-reserva.component'),
      },
      // {
      //   path: 'defer-options',
      //   title: 'Defer Options',
